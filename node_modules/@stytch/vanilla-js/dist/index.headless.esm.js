...
var HeadlessUserClient = /*#__PURE__*/_createClass(function HeadlessUserClient(_networkClient, _subscriptionService) {
  ...
  this.get = function () {
    return __awaiter$1(_this3, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
      var resp, user;
  ...
  return _createClass(HeadlessOAuthClient, [{
    ...
    value: function startOAuthFlow(providerType) {
      ...
      return function () {
        ...
        return __awaiter$1(_this8, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee42() {
...
var HeadlessIDPClient = /*#__PURE__*/_createClass(function HeadlessIDPClient(_networkClient) {
  ...
  this.oauthAuthorizeStart = function (data) {
    return __awaiter$1(_this13, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee64() {
  ...
  this.oauthAuthorizeSubmit = function (data) {
    return __awaiter$1(_this13, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee65() {
  ...
  this.oauthLogoutStart = function (data) {
    return __awaiter$1(_this13, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee66() {
...
var BootstrapDataManager = /*#__PURE__*/function () {
  function BootstrapDataManager(_publicToken, _networkClient, _dataLayer) {
    ...
    this._bootstrapDataPromise = this._networkClient.fetchSDK({
      ...
      _this14._dataLayer.setItem(BOOTSTRAP_CACHE_KEY, JSON.stringify(data));
      return data;
    })["catch"](function (error) {
      logger.error(error);
...
var CaptchaProvider = /*#__PURE__*/_createClass2(function CaptchaProvider(bootstrapPromise) {
  ...
  this.executeRecaptcha = function () {
    return __awaiter(_this15, void 0, void 0, /*#__PURE__*/_regeneratorRuntime2().mark(function _callee0() {
      var _yield$this$state4, captchaClient, configured, siteKey;
      return _regeneratorRuntime2().wrap(function _callee0$(_context0) {
        while (1) switch (_context0.prev = _context0.next) {
          case 0:
            _context0.next = 2;
            return this.state;
          case 2:
            _yield$this$state4 = _context0.sent;
          ...
          case 10:
            return _context0.abrupt("return", captchaClient.execute(siteKey, {
              action: 'LOGIN'
            }));
          case 11:
          case "end":
  ...
  this.state = bootstrapPromise.then(function (bootstrapData) {
    return __awaiter(_this15, void 0, void 0, /*#__PURE__*/_regeneratorRuntime2().mark(function _callee1() {
      return _regeneratorRuntime2().wrap(function _callee1$(_context1) {
        while (1) switch (_context1.prev = _context1.next) {
          ...
          case 4:
            ...
            _context1.t1 = bootstrapData.captchaSettings.siteKey;
            return _context1.abrupt("return", {
              configured: true,
              captchaClient: _context1.t0,
              siteKey: _context1.t1
            });
          case 7:
          case "end":
...
var ClientsideServicesProvider = /*#__PURE__*/function () {
  function ClientsideServicesProvider(iframeURL) {
    ...
    this.oneTapStart = function (req) {
      return _this16.call('oneTapStart', req);
    };
    this.oneTapSubmit = function (req) {
      return _this16.call('oneTapSubmit', req);
    };
    this.parsedPhoneNumber = function (req) {
      return _this16.call('parsedPhoneNumber', req);
    };
  }
...
var HeadlessOAuthClient = /*#__PURE__*/function (_HeadlessOAuthClient$) {
  function HeadlessOAuthClient(_networkClient, _subscriptionService, _pkceManager, _dynamicConfig, _config, _oneTap) {
    ...
    _this17 = _callSuper2(this, HeadlessOAuthClient, [_networkClient, _subscriptionService, _pkceManager, _dynamicConfig, _config]);
    _this17._oneTap = _oneTap;
    _this17.startOneTap = function (options) {
      return __awaiter(_this17, void 0, void 0, /*#__PURE__*/_regeneratorRuntime2().mark(function _callee10() {
        ...
        return _regeneratorRuntime2().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 5:
              ...
              return _context10.abrupt("return", client.render({
                style: {
    ...
    _this17.googleOneTap = {
      start: _this17.startOneTap
    };
    return _this17;
  }
  ...
  return _createClass2(NetworkClient, [{
    ...
    value: function fetchSDK(_ref8) {
      var url = _ref8.url,
        body = _ref8.body,
        method = _ref8.method;
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime2().mark(function _callee11() {
        ...
        return _regeneratorRuntime2().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              ...
              return _context11.abrupt("return", baseFetchSDK({
                basicAuthHeader: basicAuthHeader,
                body: body,
        ...
        return _regeneratorRuntime2().wrap(function _callee67$(_context67) {
          while (1) switch (_context67.prev = _context67.next) {
            case 0:
              ...
              xSDKClientHeader = window.btoa(JSON.stringify(this.createTelemetryBlob()));
              xSDKParentHostHeader = window.location.origin;
              return _context67.abrupt("return", baseSubmitFormSDK({
                basicAuthHeader: basicAuthHeader,
                body: body,
                finalURL: this.buildSDKUrl(url),
                method: method,
        ...
        return _regeneratorRuntime2().wrap(function _callee68$(_context68) {
          while (1) switch (_context68.prev = _context68.next) {
            case 0:
              ...
              xSDKClientHeader = window.btoa(JSON.stringify(this.createTelemetryBlob()));
              xSDKParentHostHeader = window.location.origin;
              return _context68.abrupt("return", _retriableFetchSDK({
                basicAuthHeader: basicAuthHeader,
                body: body,
                finalURL: this.buildSDKUrl(url),
                method: method,
        ...
        return _regeneratorRuntime2().wrap(function _callee69$(_context69) {
          while (1) switch (_context69.prev = _context69.next) {
            case 0:
              ...
              return _context69.abrupt("return", new Promise(function (resolve) {
                _this18._googleClient.prompt(function (notification) {
                  var _a, _b, _c, _d, _e;
                  ...
                  if (!notification.isDismissedMoment()) {
                    _this18.styleFrame(shouldRenderEmbeddedOneTap);
                    return resolve({
                      success: true
                    });
                  }
  ...
  function OneTapProvider(_publicToken, clientsideServices) {
    ...
    this.createOnSuccessHandler = function (_ref11) {
      ...
      return function (response) {
        return __awaiter(_this19, void 0, void 0, /*#__PURE__*/_regeneratorRuntime2().mark(function _callee70() {
          ...
          return _regeneratorRuntime2().wrap(function _callee70$(_context70) {
            while (1) switch (_context70.prev = _context70.next) {
              ...
              case 3:
                _yield$this$submitGoo = _context70.sent;
      ...
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime2().mark(function _callee71() {
        ...
        return _regeneratorRuntime2().wrap(function _callee71$(_context71) {
          while (1) switch (_context71.prev = _context71.next) {
            ...
            case 3:
              _yield$this$fetchGoog = _context71.sent;
            ...
            case 7:
              ...
              err = StytchAPIError.from(_context71.t0);
            ...
            case 13:
              _context71.t1 = GoogleOneTapClient;
              _context71.next = 16;
              return loadGoogleOneTapClient();
            case 16:
              _context71.t2 = _context71.sent;
              _context71.t3 = googleClientId;
              client = new _context71.t1(_context71.t2, _context71.t3);
              return _context71.abrupt("return", {
                success: true,
                client: client
              });
        ...
        return _regeneratorRuntime2().wrap(function _callee72$(_context72) {
          while (1) switch (_context72.prev = _context72.next) {
            case 0:
              ...
              return this.fetchGoogleStart();
            case 2:
              _yield$this$fetchGoog2 = _context72.sent;
              oauthCallbackId = _yield$this$fetchGoog2.oauthCallbackId;
              return _context72.abrupt("return", this.clientsideServices.oneTapSubmit({
                publicToken: this._publicToken,
                idToken: credential,
                loginRedirectURL: loginRedirectUrl,
...
var PKCEManager = /*#__PURE__*/function () {
  ...
  return _createClass2(PKCEManager, [{
    ...
    value: function startPKCETransaction() {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime2().mark(function _callee73() {
        var keyPair;
        return _regeneratorRuntime2().wrap(function _callee73$(_context73) {
          while (1) switch (_context73.prev = _context73.next) {
            ...
            case 2:
              keyPair = _context73.sent;
              this._dataLayer.setItem(this.key(), JSON.stringify(keyPair));
              return _context73.abrupt("return", keyPair);
            case 5:
            case "end":
    ...
    value: function createProofkeyPair() {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime2().mark(function _callee74() {
    ...
    this.browserSessionStorage = {
      getItem: function getItem(key) {
        return safeSessionStorageOperation({
          operation: 'get',
          key: getPersistentStorageKey(_this20.publicToken, key)
        });
      },
  ...
  return _createClass2(SubscriptionDataLayer, [{
    ...
    value: function removeCookies(cookiesToRemove) {
      ...
      [true, false].forEach(function (availableToSubdomains) {
        [_this21._cookiePath, null].forEach(function (path) {
    ...
    value: function generateCookieOpts(_ref19) {
      var path = _ref19.path,
        ...
        availableToSubdomains = _ref19.availableToSubdomains,
        expiresAt = _ref19.expiresAt;
      var cookieOpts = {
...
var BaseSubscriptionService = /*#__PURE__*/function () {
  function BaseSubscriptionService(_publicToken, _datalayer, _ref20) {
    var _this22 = this;
    var usingCustomApiEndpoint = _ref20.usingCustomApiEndpoint;
    _classCallCheck2(this, BaseSubscriptionService);
    this._publicToken = _publicToken;
    this._datalayer = _datalayer;
    this.fromCache = true;
    this._listen = function (e) {
      if (e.key !== getPersistentStorageKey(_this22._publicToken)) {
        return;
      }
      var parsedValue = e.newValue === null || e.newValue === 'null' ? null : JSON.parse(e.newValue);
      _this22.updateState(parsedValue, true);
    };
...
var ConsumerSubscriptionService = /*#__PURE__*/function (_BaseSubscriptionServ) {
  function ConsumerSubscriptionService() {
    ...
    _this23 = _callSuper2(this, ConsumerSubscriptionService, arguments);
    _this23.updateUser = function (user) {
      return _this23.updateState({
        user: user
      });
    };
    _this23.getUser = function () {
      var _a, _b;
      return (_b = (_a = _this23.getState()) === null || _a === void 0 ? void 0 : _a.user) !== null && _b !== void 0 ? _b : null;
    };
    _this23.getSession = function () {
      var _a, _b;
      return (_b = (_a = _this23.getState()) === null || _a === void 0 ? void 0 : _a.session) !== null && _b !== void 0 ? _b : null;
    };
    _this23.updateSession = function (resp) {
      var session = resp.session,
        user = resp.user,
        session_jwt = resp.session_jwt,
        session_token = resp.session_token;
      if (session_token && session_jwt) {
        _this23.updateStateAndTokens({
          state: {
            session: session,
            user: user
          },
...
var StytchHeadlessClient = /*#__PURE__*/_createClass2(function StytchHeadlessClient(publicTokenRaw, options) {
  ...
  this.onStateChange = function () {
    var _this24$_stateChangeC;
    return (_this24$_stateChangeC = _this24._stateChangeClient).onStateChange.apply(_this24$_stateChangeC, arguments);
  };
  var additionalTelemetryDataFn = function additionalTelemetryDataFn() {
    var _a, _b, _c, _d;
    return {
      stytch_user_id: (_b = (_a = _this24._dataLayer.state) === null || _a === void 0 ? void 0 : _a.user) === null || _b === void 0 ? void 0 : _b.user_id,
      stytch_session_id: (_d = (_c = _this24._dataLayer.state) === null || _c === void 0 ? void 0 : _c.session) === null || _d === void 0 ? void 0 : _d.session_id
    };
  };
  ...
  var idp = new HeadlessIDPClient(networkClient);
