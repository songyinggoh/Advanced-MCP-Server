...
var extractErrorMessage = require('../extractErrorMessage-CXo-CAns.js');
...
var BackArrow = function BackArrow(_ref30) {
  ...
  var _extractErrorMessage$ = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$._;
...
var ErrorDisplay = function ErrorDisplay(_ref31) {
  ...
  var _extractErrorMessage$2 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$2._;
  ...
  })), /*#__PURE__*/extractErrorMessage.wn.createElement(ErrorSVG, null), /*#__PURE__*/extractErrorMessage.wn.createElement(Text, null, text)));
};
var ErrorScreen = function ErrorScreen() {
  ...
  var _extractErrorMessage$3 = extractErrorMessage.useLingui(),
    _t2 = _extractErrorMessage$3._;
...
var EmailInput = function EmailInput(_ref32) {
  ...
  var _extractErrorMessage$4 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$4._;
...
var CircularProgressRoot = extractErrorMessage.He.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  width: ", "px;\n  height: ", "px;\n  animation: ", " 1.4s ease-in-out infinite;\n"])), function (props) {
  return props.size;
}, function (props) {
  return props.size;
}, circularRotateKeyframe);
var CircularProgressSVG = extractErrorMessage.He.svg(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: block;\n"])));
...
var mutation = function mutation() {
  return function (key, fetcher) {
    ...
    var _extractErrorMessage$5 = extractErrorMessage.useSWRConfig(),
      mutate = _extractErrorMessage$5.mutate;
    ...
    var _extractErrorMessage$6 = extractErrorMessage.useStateWithDeps({
        data: extractErrorMessage.UNDEFINED,
        error: extractErrorMessage.UNDEFINED,
        isMutating: false
      }),
      _extractErrorMessage$7 = _slicedToArray(_extractErrorMessage$6, 3),
      stateRef = _extractErrorMessage$7[0],
      stateDependencies = _extractErrorMessage$7[1],
      setState = _extractErrorMessage$7[2];
    ...
    var trigger = extractErrorMessage.T(/*#__PURE__*/function () {
      var _ref40 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(arg, opts) {
        var _extractErrorMessage$8, _extractErrorMessage$9, serializedKey, resolvedKey, options, mutationStartedAt, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _extractErrorMessage$8 = extractErrorMessage.serialize(keyRef.current), _extractErrorMessage$9 = _slicedToArray(_extractErrorMessage$8, 2), serializedKey = _extractErrorMessage$9[0], resolvedKey = _extractErrorMessage$9[1];
...
var useExtractSlug = function useExtractSlug() {
  ...
  var _extractErrorMessage$0 = extractErrorMessage.h(),
    _extractErrorMessage$1 = _slicedToArray(_extractErrorMessage$0, 2),
    pattern = _extractErrorMessage$1[0],
    setPattern = _extractErrorMessage$1[1];
  var config = useConfig();
  ...
  extractErrorMessage.p(function () {
    internal.readB2BInternals(stytchClient).bootstrap.getAsync().then(function (_ref43) {
...
var usePasswordInput = function usePasswordInput() {
  ...
  var _extractErrorMessage$12 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$12._;
  var onEvent = useEventCallback();
  var onError = useErrorCallback();
  var _extractErrorMessage$13 = extractErrorMessage.h(state.formState.passwordState.email),
    _extractErrorMessage$14 = _slicedToArray(_extractErrorMessage$13, 2),
    email = _extractErrorMessage$14[0],
    setEmail = _extractErrorMessage$14[1];
  var _extractErrorMessage$15 = extractErrorMessage.h(''),
    _extractErrorMessage$16 = _slicedToArray(_extractErrorMessage$15, 2),
    password = _extractErrorMessage$16[0],
    setPassword = _extractErrorMessage$16[1];
  var _extractErrorMessage$17 = extractErrorMessage.h(''),
    _extractErrorMessage$18 = _slicedToArray(_extractErrorMessage$17, 2),
    errorMessage = _extractErrorMessage$18[0],
    setErrorMessage = _extractErrorMessage$18[1];
  var _extractErrorMessage$19 = extractErrorMessage.h(false),
    _extractErrorMessage$20 = _slicedToArray(_extractErrorMessage$19, 2),
    isSubmitting = _extractErrorMessage$20[0],
    setIsSubmitting = _extractErrorMessage$20[1];
...
var UsePasswordText = extractErrorMessage.He(Text)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  font-weight: bold !important;\n  cursor: pointer;\n"])));
var PasswordUseButton = function PasswordUseButton(_ref50) {
  ...
  var _extractErrorMessage$21 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$21._;
...
var useParseErrorMessage = function useParseErrorMessage() {
  var _extractErrorMessage$22 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$22._;
...
var EmailForm = function EmailForm(_ref52) {
  ...
  var _extractErrorMessage$23 = extractErrorMessage.h(state.formState.passwordState.email),
    _extractErrorMessage$24 = _slicedToArray(_extractErrorMessage$23, 2),
    emailInput = _extractErrorMessage$24[0],
    setEmailInput = _extractErrorMessage$24[1];
  var parseErrorMessage = useParseErrorMessage();
  var _extractErrorMessage$25 = extractErrorMessage.useLingui(),
    _t2 = _extractErrorMessage$25._;
...
var EmailDiscoveryForm = function EmailDiscoveryForm(_ref53) {
  ...
  var _extractErrorMessage$26 = extractErrorMessage.h(state.formState.passwordState.email),
    _extractErrorMessage$27 = _slicedToArray(_extractErrorMessage$26, 2),
    email = _extractErrorMessage$27[0],
    setEmail = _extractErrorMessage$27[1];
  var _extractErrorMessage$28 = extractErrorMessage.useLingui(),
    _t3 = _extractErrorMessage$28._;
...
var ButtonInnerContainer = extractErrorMessage.He(Flex)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  margin: 8px;\n"])));
var StyledButton$2 = extractErrorMessage.He(Button)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  height: auto;\n  min-height: 45px;\n"])));
var OutlinedButton = function OutlinedButton(_ref54) {
  var onClick = _ref54.onClick,
    id = _ref54.id,
    children = _ref54.children,
    icon = _ref54.icon;
  return /*#__PURE__*/extractErrorMessage.y(StyledButton$2, {
    type: "button",
    onClick: onClick,
    variant: "outlined",
    id: id
...
var SSOButton = function SSOButton(_ref56) {
  ...
  var stytchClient = useStytch();
  var config = useConfig();
  var _extractErrorMessage$29 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$29._;
...
var SSOButtons = function SSOButtons() {
  ...
  var _extractErrorMessage$30 = extractErrorMessage.useLingui(),
    _t2 = _extractErrorMessage$30._;
...
var DividerContainer = extractErrorMessage.He(Flex)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  color: ", ";\n"])), function (props) {
  return props.theme.colors.secondary;
});
var DividerBar = extractErrorMessage.He.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  ", "\n  ", "\n  border-bottom: 1px solid ", ";\n  flex-grow: 1;\n"])), function (props) {
...
var StyledText = extractErrorMessage.He(Text)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  color: ", ";\n"])), function (props) {
  return props.theme.colors.secondary;
});
var Divider = function Divider() {
  var _extractErrorMessage$31 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$31._;
  return /*#__PURE__*/extractErrorMessage.wn.createElement(DividerContainer, {
    ...
    "$placement": "left"
  }), /*#__PURE__*/extractErrorMessage.wn.createElement(StyledText, null, _t({
...
var LoggingInScreen = function LoggingInScreen() {
  var _extractErrorMessage$32 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$32._;
  return /*#__PURE__*/extractErrorMessage.y(Flex, {
    direction: "column",
    gap: 36,
    alignItems: "center"
...
var BaseInput = extractErrorMessage.He.input(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  border: 0;\n  padding: 0;\n  width: 100%;\n\n  background-color: transparent;\n  height: 45px;\n  color: ", ";\n  font-family: ", ";\n  font-size: 18px;\n\n  &::placeholder: {\n    color: ", ";\n  }\n\n  &:disabled {\n    color: ", ";\n    background-color: ", ";\n  }\n\n  &:focus {\n    outline: none;\n  }\n"])), function (props) {
  return props.theme.inputs.textColor;
}, function (props) {
  return props.theme.typography.fontFamily;
}, function (props) {
...
var InputContainer = extractErrorMessage.He(Flex)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  height: 45px;\n  padding-left: 8px;\n  padding-right: 8px;\n  border: 1px solid ", ";\n  border-radius: ", ";\n  color: ", ";\n  font-family: ", ";\n  font-size: 18px;\n  width: calc(100% - 18px);\n  & input::placeholder: {\n    color: ", ";\n  }\n"])), function (props) {
  return props.theme.inputs.backgroundColor;
}, function (props) {
  return props.theme.inputs.borderColor;
}, function (props) {
...
var PasswordIconButton = extractErrorMessage.He.button(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  all: unset;\n  cursor: pointer;\n  color: ", ";\n\n  &:disabled {\n    cursor: default;\n  }\n"])), function (props) {
...
var PasswordIcon = function PasswordIcon(_ref57) {
  ...
  }, visible ? /*#__PURE__*/extractErrorMessage.wn.createElement(PasswordIconVisibleSvg, null) : /*#__PURE__*/extractErrorMessage.wn.createElement(PasswordIconSvg, null));
};
var PasswordInput = function PasswordInput(_ref58) {
  var password = _ref58.password,
    setPassword = _ref58.setPassword,
    type = _ref58.type;
  var _extractErrorMessage$33 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$33._;
  var _extractErrorMessage$34 = extractErrorMessage.h(false),
    _extractErrorMessage$35 = _slicedToArray(_extractErrorMessage$34, 2),
    visible = _extractErrorMessage$35[0],
    setVisible = _extractErrorMessage$35[1];
...
var GetHelpText = extractErrorMessage.He(Text)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  font-weight: bold !important;\n  cursor: pointer;\n"])));
var PasswordsAuthenticate = function PasswordsAuthenticate() {
  ...
  var _extractErrorMessage$36 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$36._;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    ...
    message: "Password"
  })), /*#__PURE__*/extractErrorMessage.wn.createElement(PasswordInput, {
    password: password,
    setPassword: setPassword,
    type: "current"
...
var PasswordsEmailForm = function PasswordsEmailForm() {
  ...
  var _extractErrorMessage$37 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$37._;
  ...
  var _extractErrorMessage$38 = extractErrorMessage.h(!!organization && !email),
    _extractErrorMessage$39 = _slicedToArray(_extractErrorMessage$38, 2),
    hideInput = _extractErrorMessage$39[0],
    setHideInput = _extractErrorMessage$39[1];
  var handleSubmit = function handleSubmit(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 9:
            setErrorMessage('');
            setIsSubmitting(true);
            internal.readB2BInternals(stytch).searchManager.searchMember(email, organization.organization_id).then(function (_ref59) {
...
extractErrorMessage.He.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  height: ", ";\n  display: ", ";\n  transition: all 0.5s ease-out;\n  justify-content: center;\n  align-items: center;\n"])), function (props) {
...
var B2BGoogleOneTap = function B2BGoogleOneTap(_ref62) {
  ...
  var _extractErrorMessage$40 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$40._;
  var stytch = useStytch();
  var config = useConfig();
  var isOnlyFloatingOneTap = useIsOnlyFloatingOneTap();
  var _extractErrorMessage$41 = extractErrorMessage.h(OneTapErrors.None),
    _extractErrorMessage$42 = _slicedToArray(_extractErrorMessage$41, 2),
    oneTapError = _extractErrorMessage$42[0],
    setOneTapError = _extractErrorMessage$42[1];
...
var OAuthButtons = function OAuthButtons() {
  var _a;
  var _extractErrorMessage$43 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$43._;
...
var LogoImage$1 = extractErrorMessage.He.img(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  max-height: 50px;\n  max-width: 100px;\n"])));
var Header = extractErrorMessage.He(Text)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  text-align: center;\n"])));
...
var MainScreen = function MainScreen() {
  var _a, _b, _c;
  var _extractErrorMessage$44 = extractErrorMessage.Ze(),
    displayHeader = _extractErrorMessage$44.displayHeader,
    logo = _extractErrorMessage$44.logo;
  ...
  var _extractErrorMessage$45 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$45._;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    gap: 24,
    direction: "column"
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(Logo$2, {
  ...
  })), /*#__PURE__*/extractErrorMessage.wn.createElement(Text, null, _t({
    id: 'emailVerification.content',
    message: "Confirm your email address with one of the following:"
  })))) : title && (/*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    justifyContent: "center"
...
var Link = extractErrorMessage.He.a(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  all: unset;\n  cursor: pointer;\n\n  &:hover {\n    text-decoration: underline;\n    text-decoration-color: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
var EmailProviderLink = function EmailProviderLink(_ref66) {
  ...
  var _extractErrorMessage$46 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$46._;
  ...
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(Text, null, _t(messageDescriptor))));
};
var EmailConfirmation$1 = function EmailConfirmation$1(_ref67) {
  var emailDomain = _ref67.emailDomain,
    reset = _ref67.reset,
    email = _ref67.email;
  var _extractErrorMessage$47 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$47._;
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    direction: "column",
    gap: 24
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(Text, {
    ...
    direction: "column",
    gap: 12
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(Text, null, /*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.Trans, {
    id: "emailConfirmation.content",
    message: "An email was sent to <bold>{email}</bold>.",
    components: {
      bold: /*#__PURE__*/extractErrorMessage.wn.createElement("b", null)
    },
    values: {
      email: email
    }
...
var useEmailDomain$1 = function useEmailDomain$1() {
  ...
  var stytch = useStytch();
  var config = useConfig();
  var _extractErrorMessage$48 = extractErrorMessage.h(function () {
    ...
    _extractErrorMessage$49 = _slicedToArray(_extractErrorMessage$48, 2),
    emailDomains = _extractErrorMessage$49[0],
    setEmailDomains = _extractErrorMessage$49[1];
  extractErrorMessage.p(function () {
    internal.readB2BInternals(stytch).bootstrap.getAsync().then(function (_ref68) {
...
var OrganizationsRow = extractErrorMessage.He(Flex)(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  gap: 8px;\n  border: ", ";\n  border-radius: ", ";\n  background-color: ", ";\n  color: ", ";\n"])), function (_ref69) {
...
var LogoImage = extractErrorMessage.He.img(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  height: 40px;\n  width: 40px;\n  flex-shrink: 0;\n  border-radius: 4px;\n"])));
var LogoText = extractErrorMessage.He(Flex)(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  height: 40px;\n  width: 40px;\n  flex-shrink: 0;\n  background-color: ", ";\n  color: ", ";\n  border-radius: 4px;\n\n  font-style: normal;\n  font-weight: 400;\n  font-size: 18px;\n  line-height: 25px;\n"])), function (_ref73) {
...
var OrganizationName = extractErrorMessage.He.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  overflow-wrap: break-word;\n  word-break: break-word;\n  hyphens: auto;\n"])));
var ArrowText = extractErrorMessage.He.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  ", ";\n  text-align: right;\n"])), function (_ref75) {
  var theme = _ref75.theme;
  return theme.typography.body;
});
var SvgNoShrink = extractErrorMessage.He.svg(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  flex-shrink: 0;\n"])));
...
var ActionText = function ActionText(_ref77) {
  ...
  var _extractErrorMessage$50 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$50._;
  if (isJoinViaJitType(type) || type === 'pending_member') return /*#__PURE__*/extractErrorMessage.y(ArrowText, null, _t({
    id: 'organizationDiscovery.join',
    message: "Join"
  }));
  if (type === 'invited_member') return /*#__PURE__*/extractErrorMessage.y(ArrowText, null, _t({
...
var DiscoverNoOrganizations = function DiscoverNoOrganizations() {
  ...
  var _extractErrorMessage$51 = extractErrorMessage.useLingui(),
    _t2 = _extractErrorMessage$51._;
  ...
  if (createOrganizationEnabled && !config.disableCreateOrganization) {
    ...
    })), /*#__PURE__*/extractErrorMessage.y(Button, {
      type: "button",
      onClick: function onClick() {
    ...
    })), /*#__PURE__*/extractErrorMessage.y(Text, null, _t2({
...
var Discovery = function Discovery() {
  ...
  var stytchClient = useStytch();
  var config = useConfig();
  var _extractErrorMessage$52 = extractErrorMessage.useLingui(),
    _t3 = _extractErrorMessage$52._;
  ...
  return /*#__PURE__*/extractErrorMessage.y(Flex, {
    ...
    return /*#__PURE__*/extractErrorMessage.y(OrganizationsRow, {
      ...
      gap: 8,
      alignItems: "center"
    }, /*#__PURE__*/extractErrorMessage.y(Logo$1, {
...
var Confirmation = function Confirmation(_ref79) {
  var header = _ref79.header,
    text = _ref79.text;
  var _extractErrorMessage$53 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$53._;
  ...
  return /*#__PURE__*/extractErrorMessage.y(Flex, {
    ...
    size: "header"
  }, header !== null && header !== void 0 ? header : defaultHeader), /*#__PURE__*/extractErrorMessage.y(Text, null, text !== null && text !== void 0 ? text : defaultText), /*#__PURE__*/extractErrorMessage.y(ConfirmationSVG, null));
};
...
var StyledButton$1 = extractErrorMessage.He.button(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  all: unset;\n  color: ", ";\n  cursor: pointer;\n  padding: 20px 0;\n  border-bottom: 1px solid #e5e8eb;\n  font-weight: 500;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"])), function (props) {
  return props.theme.colors.primary;
});
var MenuText = extractErrorMessage.He.div(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  flex: 1 1 auto;\n"])));
var ChevronContainer = extractErrorMessage.He.span(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  flex: 0 0 auto;\n"])));
var MenuButton = function MenuButton(_ref80) {
  var children = _ref80.children,
    disabled = _ref80.disabled,
    onClick = _ref80.onClick;
  return /*#__PURE__*/extractErrorMessage.wn.createElement(StyledButton$1, {
    type: "button",
    onClick: onClick,
    disabled: disabled
...
var EmailMethodSelectionScreen = function EmailMethodSelectionScreen() {
  ...
  var _extractErrorMessage$54 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$54._;
...
var StyledButton = extractErrorMessage.He.button(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["\n  all: unset;\n\n  b {\n    cursor: pointer;\n  }\n\n  &:disabled {\n    cursor: not-allowed;\n    pointer-events: none;\n  }\n"])));
var InlineButton = function InlineButton(_ref82) {
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(StyledButton, {
    ...
    disabled: disabled,
    className: className
  }, /*#__PURE__*/extractErrorMessage.wn.createElement("b", null, children));
};
...
var OTPInput = function OTPInput(_ref92) {
  ...
  var _extractErrorMessage$55 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$55._;
...
var OTPControl = function OTPControl(_ref93) {
  ...
  var _extractErrorMessage$56 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$56._;
  var _extractErrorMessage$57 = extractErrorMessage.h(''),
    _extractErrorMessage$58 = _slicedToArray(_extractErrorMessage$57, 2),
    otp = _extractErrorMessage$58[0],
    setOtp = _extractErrorMessage$58[1];
  ...
  })), /*#__PURE__*/extractErrorMessage.wn.createElement(LoadingBar, {
    isLoading: isSubmitting
...
var rollToSuccess = extractErrorMessage.Ue(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["\n  from {\n    transform: translateY(0%);\n  }\n  to {\n    transform: translateY(-50%);\n  }\n"])));
var rollToDefault = extractErrorMessage.Ue(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["\n  from {\n    transform: translateY(-50%);\n  }\n  to {\n    transform: translateY(0%);\n  }\n"])));
var AnimatedWrapper = extractErrorMessage.He.div(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["\n  position: relative;\n  overflow: hidden;\n  /* Set an explicit height to create the \"window\" the animation will be displayed in.  We match to the line height to ensure it looks inline with the text */\n  height: ", ";\n"])), function (_ref95) {
  var theme = _ref95.theme;
  return theme.typography.helper.lineHeight;
});
var RollingContainer = extractErrorMessage.He.div(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  animation: ", "\n    0.3s ease-out;\n  transform: ", ";\n"])), function (_ref96) {
...
var StyledInlineButton = extractErrorMessage.He(InlineButton)(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral(["\n  color: ", ";\n"])), function (_ref98) {
...
var ExpirationMessage = function ExpirationMessage(_ref99) {
  ...
  var _extractErrorMessage$59 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$59._;
  var _extractErrorMessage$60 = extractErrorMessage.h(function () {
      return getSecondsRemaining(expiration);
    }),
    _extractErrorMessage$61 = _slicedToArray(_extractErrorMessage$60, 2),
    seconds = _extractErrorMessage$61[0],
    setSeconds = _extractErrorMessage$61[1];
  var _extractErrorMessage$62 = extractErrorMessage.h('initial'),
    _extractErrorMessage$63 = _slicedToArray(_extractErrorMessage$62, 2),
    resendState = _extractErrorMessage$63[0],
    setResendState = _extractErrorMessage$63[1];
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.wn.Fragment, null, formattedText, /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    direction: "row",
    gap: 8,
    alignItems: "center"
  }, _t({
  ...
  }), /*#__PURE__*/extractErrorMessage.wn.createElement(AnimatedWrapper, null, /*#__PURE__*/extractErrorMessage.wn.createElement(RollingContainer, {
    displayCodeSent: resendState === 'sent',
    shouldAnimate: resendState === 'sent' || resendState === 'waiting'
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(StyledInlineButton, {
...
var SentOTPEntry = function SentOTPEntry(_ref100) {
  ...
  var _extractErrorMessage$64 = extractErrorMessage.useLingui(),
    _t2 = _extractErrorMessage$64._;
  var helperContent = /*#__PURE__*/extractErrorMessage.wn.createElement(ExpirationMessage, {
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(OTPEntry, {
    ...
    instruction: /*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.Trans, {
...
var EmailOTPEntryScreen = function EmailOTPEntryScreen() {
  var stytchClient = useStytch();
  var config = useConfig();
  var _extractErrorMessage$65 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$65._;
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          ...
          case 5:
            ...
            break;
          case 7:
            if (!(state.flowState.type === internal.AuthFlowType.Organization && state.flowState.organization)) {
              _context8.next = 10;
              break;
            }
            _context8.next = 10;
...
var MFAEnrollmentSelectionScreen = function MFAEnrollmentSelectionScreen() {
  var _extractErrorMessage$66 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$66._;
...
var VerifyEmailConfirmation = function VerifyEmailConfirmation(_ref104) {
  var emailDomain = _ref104.emailDomain,
    reset = _ref104.reset,
    email = _ref104.email;
  var _extractErrorMessage$67 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$67._;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    ...
    color: "secondary"
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.Trans, {
    id: "password.verification.resendEmail",
    message: "Didn't get it? <resendButton>Resend email</resendButton>",
    components: {
      resendButton: /*#__PURE__*/extractErrorMessage.wn.createElement(GetHelpText, {
        color: "secondary",
        onClick: reset
      })
    }
...
var useEmailDomain = function useEmailDomain() {
  ...
  var _extractErrorMessage$68 = extractErrorMessage.h(function () {
    ...
    _extractErrorMessage$69 = _slicedToArray(_extractErrorMessage$68, 2),
    emailDomains = _extractErrorMessage$69[0],
    setEmailDomains = _extractErrorMessage$69[1];
  extractErrorMessage.p(function () {
    internal.readB2BInternals(stytch).bootstrap.getAsync().then(function (_ref105) {
...
var Block = extractErrorMessage.He.div(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral(["\n  height: 4px;\n  width: 25%;\n  background-color: ", ";\n"])), function (props) {
...
var BulletPoint = extractErrorMessage.He.div(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  width: 16px;\n  flex-shrink: 0;\n\n  &::before {\n    content: '\u2022';\n    font-size: ", ";\n    line-height: ", ";\n    color: ", ";\n  }\n"])), function (_ref107) {
...
var CrossIconContainer = extractErrorMessage.He.div(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["\n  flex-shrink: 0;\n  padding-top: 2px;\n"])));
var PasswordError = function PasswordError(_a) {
  var _b, _c, _d, _e, _f;
  var bootstrap = _a.bootstrap,
    props = internal.__rest(_a, ["bootstrap"]);
  var _extractErrorMessage$70 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$70._;
  ...
  if (props.passwordPolicy === 'zxcvbn') {
    ...
    return /*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.wn.Fragment, null, /*#__PURE__*/extractErrorMessage.wn.createElement(PasswordStrengthCheck, {
    ...
    }), props.errorMessage && /*#__PURE__*/extractErrorMessage.wn.createElement(ErrorText, {
      errorMessage: props.errorMessage
    }), translatedWarning && (/*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
      gap: 1,
      alignItems: "flex-start"
    }, /*#__PURE__*/extractErrorMessage.wn.createElement(CrossIconContainer, null, /*#__PURE__*/extractErrorMessage.wn.createElement(CrossIcon, null)), /*#__PURE__*/extractErrorMessage.wn.createElement(Text, {
      size: "helper",
      color: "error"
      ...
      return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
        ...
        gap: 1,
        alignItems: "flex-start"
      }, /*#__PURE__*/extractErrorMessage.wn.createElement(BulletPoint, null), ' ', /*#__PURE__*/extractErrorMessage.wn.createElement(Text, {
        size: "helper",
        color: "secondary"
      }, _t(suggestion)));
    }));
  ...
  }))), props.isPasswordBreached && (/*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    gap: 4
...
var PasswordB2BError = function PasswordB2BError(props) {
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(PasswordError, Object.assign({}, props, {
    bootstrap: bootstrap
  }));
};
...
var Form = extractErrorMessage.He.form(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["\n  width: 100%;\n"])));
var PasswordResetForm = function PasswordResetForm() {
  ...
  var _extractErrorMessage$71 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$71._;
  var onEvent = useEventCallback();
  var onError = useErrorCallback();
  var _extractErrorMessage$72 = extractErrorMessage.h(''),
    _extractErrorMessage$73 = _slicedToArray(_extractErrorMessage$72, 2),
    resetTokenType = _extractErrorMessage$73[0],
    setResetTokenType = _extractErrorMessage$73[1];
  var _extractErrorMessage$74 = extractErrorMessage.h(''),
    _extractErrorMessage$75 = _slicedToArray(_extractErrorMessage$74, 2),
    resetToken = _extractErrorMessage$75[0],
    setResetToken = _extractErrorMessage$75[1];
  var dataLayer = internal.readB2BInternals(stytchClient).dataLayer;
  var email = dataLayer.getItem('reset-email-value');
  var _extractErrorMessage$76 = extractErrorMessage.h(''),
    _extractErrorMessage$77 = _slicedToArray(_extractErrorMessage$76, 2),
    password = _extractErrorMessage$77[0],
    setPassword = _extractErrorMessage$77[1];
  var _extractErrorMessage$78 = extractErrorMessage.h(''),
    _extractErrorMessage$79 = _slicedToArray(_extractErrorMessage$78, 2),
    errorMessage = _extractErrorMessage$79[0],
    setErrorMessage = _extractErrorMessage$79[1];
  var _extractErrorMessage$80 = extractErrorMessage.h(0),
    _extractErrorMessage$81 = _slicedToArray(_extractErrorMessage$80, 2),
    passwordScore = _extractErrorMessage$81[0],
    setPasswordScore = _extractErrorMessage$81[1];
  var _extractErrorMessage$82 = extractErrorMessage.h(''),
    _extractErrorMessage$83 = _slicedToArray(_extractErrorMessage$82, 2),
    passwordWarning = _extractErrorMessage$83[0],
    setPasswordWarning = _extractErrorMessage$83[1];
  var _extractErrorMessage$84 = extractErrorMessage.h([]),
    _extractErrorMessage$85 = _slicedToArray(_extractErrorMessage$84, 2),
    passwordSuggestions = _extractErrorMessage$85[0],
    setPasswordSuggestions = _extractErrorMessage$85[1];
  var _extractErrorMessage$86 = extractErrorMessage.h(true),
    _extractErrorMessage$87 = _slicedToArray(_extractErrorMessage$86, 2),
    invalidPassword = _extractErrorMessage$87[0],
    setInvalidPassword = _extractErrorMessage$87[1];
  var _extractErrorMessage$88 = extractErrorMessage.h(false),
    _extractErrorMessage$89 = _slicedToArray(_extractErrorMessage$88, 2),
    isSubmitting = _extractErrorMessage$89[0],
    setIsSubmitting = _extractErrorMessage$89[1];
  var _extractErrorMessage$90 = extractErrorMessage.h('none'),
    _extractErrorMessage$91 = _slicedToArray(_extractErrorMessage$90, 2),
    strengthPolicy = _extractErrorMessage$91[0],
    setStrengthPolicy = _extractErrorMessage$91[1];
  var _extractErrorMessage$92 = extractErrorMessage.h(0),
    _extractErrorMessage$93 = _slicedToArray(_extractErrorMessage$92, 2),
    missingCharacters = _extractErrorMessage$93[0],
    setMissingCharacters = _extractErrorMessage$93[1];
  var _extractErrorMessage$94 = extractErrorMessage.h(0),
    _extractErrorMessage$95 = _slicedToArray(_extractErrorMessage$94, 2),
    missingComplexity = _extractErrorMessage$95[0],
    setMissingComplexity = _extractErrorMessage$95[1];
  var _extractErrorMessage$96 = extractErrorMessage.h(false),
    _extractErrorMessage$97 = _slicedToArray(_extractErrorMessage$96, 2),
    isPasswordBreached = _extractErrorMessage$97[0],
    setIsPasswordBreached = _extractErrorMessage$97[1];
...
var S = new Map(),
  ...
  I = function I() {
    ...
    var _extractErrorMessage$98 = extractErrorMessage.h(P),
      _extractErrorMessage$99 = _slicedToArray(_extractErrorMessage$98, 2),
      t = _extractErrorMessage$99[0],
      o = _extractErrorMessage$99[1];
    extractErrorMessage.p(function () {
...
var ye = function ye(e) {
  ...
  F = extractErrorMessage.w(function (_ref116) {
    var e = _ref116.toast,
      t = _ref116.position,
      o = _ref116.style,
      s = _ref116.children;
...
var PasswordSetNew = function PasswordSetNew() {
  ...
  var onEvent = useEventCallback();
  var config = useConfig();
  var _extractErrorMessage$100 = extractErrorMessage.useLingui(),
    _t$1 = _extractErrorMessage$100._;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    ...
    message: "Didn't get it? <resendButton>Resend email</resendButton>",
    components: {
      resendButton: /*#__PURE__*/extractErrorMessage.wn.createElement(ResendButton, {
...
var PasswordsForgotForm = function PasswordsForgotForm() {
  ...
  var config = useConfig();
  var onEvent = useEventCallback();
  var _extractErrorMessage$101 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$101._;
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          ...
          case 4:
            ...
            setIsSubmitting(true);
            if (organization) {
              internal.readB2BInternals(stytch).searchManager.searchMember(email, organization.organization_id).then(function (_ref120) {
  ...
  })), /*#__PURE__*/extractErrorMessage.wn.createElement(Text, null, !organization ? _t({
...
var RecoveryCodeEntryScreen = function RecoveryCodeEntryScreen() {
  ...
  var _extractErrorMessage$102 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$102._;
  ...
  var _extractErrorMessage$103 = extractErrorMessage.h(''),
    _extractErrorMessage$104 = _slicedToArray(_extractErrorMessage$103, 2),
    recoveryCode = _extractErrorMessage$104[0],
    setRecoveryCode = _extractErrorMessage$104[1];
  ...
  var handleSubmit = function handleSubmit(e) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee0() {
...
var InsetContainer = extractErrorMessage.He.div(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral(["\n  background-color: #f3f5f6;\n  color: #000;\n  font-size: 16px;\n  line-height: 28px;\n  display: flex;\n  align-items: flex-start;\n  justify-content: center;\n  gap: 8px;\n  padding: 16px 8px;\n"])));
var CodeList = extractErrorMessage.He.ul(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral(["\n  list-style: none;\n  padding: 0;\n  margin: 0;\n"])));
...
var RecoveryCodeSaveScreen = function RecoveryCodeSaveScreen() {
  ...
  var _extractErrorMessage$105 = extractErrorMessage.useLingui(),
    _t$1 = _extractErrorMessage$105._;
  ...
  var handleCodesCopy = function handleCodesCopy() {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee1() {
  ...
  })), /*#__PURE__*/extractErrorMessage.wn.createElement(Text, null, _t$1({
    id: 'recoveryCodes.save.content',
    message: "This is the only time you will be able to access and save your backup codes."
  })), /*#__PURE__*/extractErrorMessage.wn.createElement(InsetContainer, null, /*#__PURE__*/extractErrorMessage.wn.createElement(CodeList, null, recoveryCodes.map(function (code, i) {
...
var Select = extractErrorMessage.He.select(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: ", ";\n  height: 47px;\n  box-sizing: border-box;\n  padding: 0 8px;\n  color: ", ";\n  font-family: ", ";\n  width: 80px;\n  font-size: 18px;\n"])), function (props) {
  return props.theme.inputs.backgroundColor;
}, function (props) {
  return props.theme.inputs.borderColor;
}, function (props) {
...
var CountrySelector = function CountrySelector(_ref122) {
  ...
  }, Object.entries(internal.COUNTRIES_LIST).map(function (_ref123) {
...
var PhoneStyledInput = extractErrorMessage.He(Input)(_templateObject68 || (_templateObject68 = _taggedTemplateLiteral(["\n  flex-grow: 1;\n  min-width: 100px;\n"])));
...
var SMSOTPEnrollScreen = function SMSOTPEnrollScreen() {
  ...
  var _extractErrorMessage$106 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$106._;
  ...
  var _extractErrorMessage$107 = extractErrorMessage.wn.useState((_a = enrolledNumber === null || enrolledNumber === void 0 ? void 0 : enrolledNumber.countryCode) !== null && _a !== void 0 ? _a : DEFAULT_COUNTRY_CODE),
    _extractErrorMessage$108 = _slicedToArray(_extractErrorMessage$107, 2),
    countryCode = _extractErrorMessage$108[0],
    setCountryCode = _extractErrorMessage$108[1];
  var _extractErrorMessage$109 = extractErrorMessage.wn.useState((_b = enrolledNumber === null || enrolledNumber === void 0 ? void 0 : enrolledNumber.phoneNumber) !== null && _b !== void 0 ? _b : ''),
    _extractErrorMessage$110 = _slicedToArray(_extractErrorMessage$109, 2),
    phoneNumber = _extractErrorMessage$110[0],
    setPhoneNumber = _extractErrorMessage$110[1];
  var errorMessage = extractErrorMessage.wn.useMemo(function () {
...
var SMSOTPEntryScreen = function SMSOTPEntryScreen() {
  ...
  var _extractErrorMessage$111 = extractErrorMessage.useLingui(),
    _t$1 = _extractErrorMessage$111._;
...
var SSODiscoveryEmail = function SSODiscoveryEmail() {
  ...
  var _extractErrorMessage$112 = extractErrorMessage.h(''),
    _extractErrorMessage$113 = _slicedToArray(_extractErrorMessage$112, 2),
    email = _extractErrorMessage$113[0],
    setEmail = _extractErrorMessage$113[1];
  var _extractErrorMessage$114 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$114._;
  var _extractErrorMessage$115 = extractErrorMessage.h(null),
    _extractErrorMessage$116 = _slicedToArray(_extractErrorMessage$115, 2),
    error = _extractErrorMessage$116[0],
    setError = _extractErrorMessage$116[1];
  var _extractErrorMessage$117 = extractErrorMessage.h(false),
    _extractErrorMessage$118 = _slicedToArray(_extractErrorMessage$117, 2),
    isLoading = _extractErrorMessage$118[0],
    setIsLoading = _extractErrorMessage$118[1];
                ...
                return _regeneratorRuntime().wrap(function _callee18$(_context18) {
                  while (1) switch (_context18.prev = _context18.next) {
                    ...
                    case 9:
                      ...
                      setError((_a = extractErrorMessage.extractErrorMessage(_context18.t0, _t({
...
var SSODiscoveryMenu = function SSODiscoveryMenu() {
  ...
  var _extractErrorMessage$119 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$119._;
  var handleBack = function handleBack() {
    dispatch({
      type: 'navigate_back'
    });
...
var SSODiscoveryFallback = function SSODiscoveryFallback() {
  ...
  var _extractErrorMessage$120 = extractErrorMessage.h(''),
    _extractErrorMessage$121 = _slicedToArray(_extractErrorMessage$120, 2),
    slug = _extractErrorMessage$121[0],
    setSlug = _extractErrorMessage$121[1];
  var _extractErrorMessage$122 = extractErrorMessage.h(null),
    _extractErrorMessage$123 = _slicedToArray(_extractErrorMessage$122, 2),
    error = _extractErrorMessage$123[0],
    setError = _extractErrorMessage$123[1];
  var _extractErrorMessage$124 = extractErrorMessage.h(false),
    _extractErrorMessage$125 = _slicedToArray(_extractErrorMessage$124, 2),
    isSubmitting = _extractErrorMessage$125[0],
    setIsSubmitting = _extractErrorMessage$125[1];
  var stytchClient = useStytch();
  var _useConfig6 = useConfig(),
    ssoOptions = _useConfig6.ssoOptions;
  var _extractErrorMessage$126 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$126._;
...
var CopyButton = extractErrorMessage.He.button(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral(["\n  all: unset;\n  flex: 0 0 24px;\n  height: 28px;\n  opacity: 0;\n  :focus {\n    opacity: 1;\n  }\n"])));
var CodeContainer = extractErrorMessage.He(InsetContainer)(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  :hover ", " {\n    opacity: 1;\n  }\n"])), CopyButton);
var Spacer = extractErrorMessage.He.div(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral(["\n  flex: 0 1 24px;\n"])));
var Code = extractErrorMessage.He.code(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral(["\n  white-space: pre-wrap;\n  align-self: center;\n  text-align: center;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-wrap: wrap;\n  gap: 1ch;\n"])));
var TOTPEnrollManualScreen = function TOTPEnrollManualScreen() {
  ...
  var _extractErrorMessage$127 = extractErrorMessage.useLingui(),
    _t$1 = _extractErrorMessage$127._;
  ...
  })), /*#__PURE__*/extractErrorMessage.wn.createElement(CodeContainer, {
...
var QRCodeImg = extractErrorMessage.He.img(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral(["\n  margin: 0 auto;\n"])));
var TOTPEnrollQRScreen = function TOTPEnrollQRScreen() {
  ...
  var _extractErrorMessage$128 = extractErrorMessage.useLingui(),
    _t$1 = _extractErrorMessage$128._;
  ...
  })), !!enrollment ? (/*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.wn.Fragment, null, /*#__PURE__*/extractErrorMessage.wn.createElement(QRCodeImg, {
    alt: _t$1({
...
var TOTPEntry = function TOTPEntry(_ref134) {
  ...
  var _extractErrorMessage$129 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$129._;
  return /*#__PURE__*/extractErrorMessage.wn.createElement(OTPEntry, {
    header: _t({
      id: 'totp.title',
...
var TOTPEntryScreen = function TOTPEntryScreen() {
  ...
  var _extractErrorMessage$130 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$130._;
  ...
  var helperContent = !isEnrolling ? (/*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.Trans, {
    ...
    components: {
      backupCodeLink: /*#__PURE__*/extractErrorMessage.wn.createElement(InlineButton, {
...
var OuterContainer = extractErrorMessage.He.div(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral(["\n  width: ", ";\n  font-family: ", ";\n  box-sizing: border-box;\n  * {\n    box-sizing: content-box;\n  }\n  background-color: ", ";\n  border: ", ";\n  border-radius: ", ";\n  border-bottom-left-radius: ", ";\n  border-bottom-right-radius: ", ";\n  border-bottom: ", ";\n"])), function (_ref136) {
...
var ChildrenContainer = extractErrorMessage.He.div(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral(["\n  padding: 24px 32px;\n"])));
var WatermarkContainer = extractErrorMessage.He.div(_templateObject76 || (_templateObject76 = _taggedTemplateLiteral(["\n  box-sizing: border-box;\n  width: ", ";\n  background-color: ", ";\n  border: ", ";\n  border-top: none;\n  border-bottom-left-radius: ", ";\n  border-bottom-right-radius: ", ";\n  overflow: hidden;\n"])), function (_ref144) {
...
var InnerContainer = extractErrorMessage.He.div(_templateObject77 || (_templateObject77 = _taggedTemplateLiteral(["\n  background-color: #fff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  opacity: 0.5;\n"])));
var Image = extractErrorMessage.He.img(_templateObject78 || (_templateObject78 = _taggedTemplateLiteral(["\n  width: 150px;\n"])));
...
var MainContainer = function MainContainer(_ref150) {
  ...
  var _extractErrorMessage$131 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$131._;
...
var ScopeList = extractErrorMessage.He.ul(_templateObject79 || (_templateObject79 = _taggedTemplateLiteral(["\n  padding: 0;\n"])));
var ScopeListItem = extractErrorMessage.He.li(_templateObject80 || (_templateObject80 = _taggedTemplateLiteral(["\n  padding: 4px;\n  box-sizing: border-box;\n  position: relative;\n  list-style: none;\n\n  &:not(:last-child) {\n    border-bottom: 1px solid ", ";\n  }\n"])), function (_ref153) {
  var theme = _ref153.theme;
  return theme.colors.secondary;
});
var ItemSummary = extractErrorMessage.He.summary(_templateObject81 || (_templateObject81 = _taggedTemplateLiteral(["\n  list-style: none;\n  display: flex;\n  justify-content: space-between;\n  cursor: ", ";\n"])), function (props) {
  return props.expandable ? 'pointer' : 'default';
});
var DropdownArrowSvg = extractErrorMessage.He.svg(_templateObject82 || (_templateObject82 = _taggedTemplateLiteral(["\n  width: 32px;\n  height: 32px;\n  margin-left: 10px;\n  margin-top: -5px;\n  vertical-align: top;\n  flex-shrink: 0;\n  transition: transform 0.3s ease;\n  details[open] & {\n    transform: rotate(90deg);\n  }\n"])));
var ItemNestedDetailsList = extractErrorMessage.He.ul(_templateObject83 || (_templateObject83 = _taggedTemplateLiteral(["\n  padding: 4px 24px;\n  list-style: none;\n"])));
...
var SectionHeader = extractErrorMessage.He(Text)(_templateObject84 || (_templateObject84 = _taggedTemplateLiteral(["\n  font-weight: 600;\n"])));
...
var ConsentManifest = function ConsentManifest(_ref156) {
  ...
  var _extractErrorMessage$132 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$132._;
...
var UngrantableSection = extractErrorMessage.He.details(_templateObject85 || (_templateObject85 = _taggedTemplateLiteral(["\n  border: ", ";\n  border-radius: ", ";\n  padding: 16px;\n  margin-bottom: 36px;\n"])), function (_ref157) {
...
var UngrantableSummary = extractErrorMessage.He.summary(_templateObject86 || (_templateObject86 = _taggedTemplateLiteral(["\n  list-style: none;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  cursor: pointer;\n\n  details[open] > & {\n    padding-bottom: 8px;\n    margin-bottom: 8px;\n    border-bottom: 1px solid ", ";\n  }\n"])), function (_ref159) {
  var theme = _ref159.theme;
  return theme.colors.secondary;
});
var UngrantableNestedDetailsList = extractErrorMessage.He.ul(_templateObject87 || (_templateObject87 = _taggedTemplateLiteral(["\n  padding: 4px;\n  margin: 0;\n  list-style: none;\n"])));
var UngrantableScopes = function UngrantableScopes(_ref160) {
  ...
  var _extractErrorMessage$133 = extractErrorMessage.useLingui(),
    _t2 = _extractErrorMessage$133._;
  ...
  })), /*#__PURE__*/extractErrorMessage.wn.createElement(DropdownArrow, null)), /*#__PURE__*/extractErrorMessage.wn.createElement(Text, {
    size: "helper",
    color: "secondary"
  }, _t2({
  ...
  })), /*#__PURE__*/extractErrorMessage.wn.createElement(UngrantableNestedDetailsList, null, ungrantableScopeDescriptions.map(function (desc, i) {
    return /*#__PURE__*/extractErrorMessage.wn.createElement("li", {
      key: i
    }, /*#__PURE__*/extractErrorMessage.wn.createElement(Text, {
      size: "helper",
...
var TrustedAuthTokenParamsContext = /*#__PURE__*/extractErrorMessage.F$1(undefined);
var IDPContextProvider = function IDPContextProvider(_ref161) {
  ...
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(TrustedAuthTokenParamsContext.Provider, {
...
var useTrustedAuthTokenParams = function useTrustedAuthTokenParams() {
  return extractErrorMessage.q(TrustedAuthTokenParamsContext);
};
var Logo = extractErrorMessage.He.img(_templateObject88 || (_templateObject88 = _taggedTemplateLiteral(["\n  max-height: 50px;\n  max-width: 100px;\n"])));
...
var useIDPState = function useIDPState(_ref162) {
  ...
  var _extractErrorMessage$134 = extractErrorMessage.s(idpStateReducer, initialState$1(initialError, initialParams)),
    _extractErrorMessage$135 = _slicedToArray(_extractErrorMessage$134, 2),
    state = _extractErrorMessage$135[0],
    dispatch = _extractErrorMessage$135[1];
  ...
  var submitInternal = extractErrorMessage.T(function (_ref163) {
  ...
  var submit = extractErrorMessage.T(function (_ref164) {
      ...
      return _regeneratorRuntime().wrap(function _callee25$(_context25) {
        while (1) switch (_context25.prev = _context25.next) {
          ...
          case 8:
            ...
            err = internal.StytchAPIError.from(_context25.t0);
...
var IDPConsent = function IDPConsent(_ref165) {
  ...
  var _a;
  var _extractErrorMessage$136 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$136._;
  ...
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(UngrantableScopes, {
...
var Consent = function Consent(_ref166) {
  ...
  var _extractErrorMessage$137 = extractErrorMessage.useLingui(),
    _t2 = _extractErrorMessage$137._;
  var _extractErrorMessage$138 = extractErrorMessage.Ze(),
    logo = _extractErrorMessage$138.logo;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    direction: "column",
    gap: 24
  }, logo.logoImageUrl && (/*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    justifyContent: "center"
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(Logo, {
...
var useLogoutState = function useLogoutState(_ref167) {
  ...
  var _extractErrorMessage$139 = extractErrorMessage.s(logoutStateReducer, initialState(initialError)),
    _extractErrorMessage$140 = _slicedToArray(_extractErrorMessage$139, 2),
    state = _extractErrorMessage$140[0],
    dispatch = _extractErrorMessage$140[1];
  var onErrorRef = extractErrorMessage._(onError);
  extractErrorMessage.p(function () {
    onErrorRef.current = onError;
  }, [onError]);
      ...
      return _regeneratorRuntime().wrap(function _callee27$(_context27) {
        while (1) switch (_context27.prev = _context27.next) {
          ...
          case 7:
            ...
            err = internal.StytchAPIError.from(_context27.t0);
            message = err.error_message;
            dispatch({
              type: 'PREFLIGHT_ERROR',
              error: message
  ...
  var submit = extractErrorMessage.T(function (_ref168) {
...
var IDPLogout = function IDPLogout(_ref169) {
  ...
  var _extractErrorMessage$141 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$141._;
  var loading = state.loading,
    error = state.error,
    denied = state.denied;
  if (loading || bootstrapNotLoaded) {
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    ...
    id: 'idpLogout.title',
    message: "Log out?"
  })), /*#__PURE__*/extractErrorMessage.wn.createElement("div", null, _t({
    id: 'idpLogout.confirmMessage',
    message: "Are you sure you want to log out of your {projectName} account?",
    values: {
      projectName: projectName
    }
  })), /*#__PURE__*/extractErrorMessage.wn.createElement("div", null, /*#__PURE__*/extractErrorMessage.wn.createElement(Button, {
    type: "button",
    onClick: function onClick() {
      return submit({
        consent_granted: true
...
var IDPConsentScreenImpl = function IDPConsentScreenImpl(_ref170) {
  ...
  var attestTrustedToken = function attestTrustedToken(authTokenParams) {
    return internal.__awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee29() {
...
var IDPConsentScreen = function IDPConsentScreen() {
  var _extractErrorMessage$142 = extractErrorMessage.h(parseIDPParams(window.location.search)),
    _extractErrorMessage$143 = _slicedToArray(_extractErrorMessage$142, 1),
    parseResult = _extractErrorMessage$143[0];
...
var EnsureMemberIsLoggedIn = function EnsureMemberIsLoggedIn(_ref172) {
  ...
  var _extractErrorMessage$144 = extractErrorMessage.useLingui(),
    _t = _extractErrorMessage$144._;
...
var AppContainer$1 = function AppContainer$1() {
  ...
  var stytchClient = useStytch();
  var config = useConfig();
  var _extractErrorMessage$145 = extractErrorMessage.Ze(),
    displayWatermark = _extractErrorMessage$145.displayWatermark;
  var isOnlyFloatingOneTap = useIsOnlyFloatingOneTap();
...
var AppContainer = function AppContainer(_ref179) {
  ...
  var _extractErrorMessage$146 = extractErrorMessage.h(function () {
    ...
    _extractErrorMessage$147 = _slicedToArray(_extractErrorMessage$146, 2),
    displayWatermark = _extractErrorMessage$147[0],
    setDisplayWatermark = _extractErrorMessage$147[1];
  extractErrorMessage.p(function () {
    internal.readB2BInternals(client).bootstrap.getAsync().then(function (data) {
  ...
  var configWithDefaults = extractErrorMessage.F(function () {
    var _a;
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(GlobalContextProvider, {
    ...
    theme: theme
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.I18nProviderWrapper, {
    messages: messages,
    overrides: strings
...
var B2BIDPContainer = function B2BIDPContainer(_ref180) {
  ...
  return /*#__PURE__*/extractErrorMessage.wn.createElement(GlobalContextProvider, {
    ...
    callbacks: callbacks,
    initialState: initialState
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(IDPContextProvider, {
