        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _context3.abrupt("return", baseFetchSDK({
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              xSDKClientHeader = window.btoa(JSON.stringify(this.createTelemetryBlob()));
              xSDKParentHostHeader = window.location.origin;
              return _context4.abrupt("return", baseSubmitFormSDK({
                basicAuthHeader: basicAuthHeader,
                body: body,
                finalURL: this.buildSDKUrl(url),
                method: method,
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              xSDKClientHeader = window.btoa(JSON.stringify(this.createTelemetryBlob()));
              xSDKParentHostHeader = window.location.origin;
              return _context5.abrupt("return", _retriableFetchSDK({
                basicAuthHeader: basicAuthHeader,
                body: body,
                finalURL: this.buildSDKUrl(url),
                method: method,
    ...
    this.browserSessionStorage = {
      getItem: function getItem(key) {
        return safeSessionStorageOperation({
          operation: 'get',
          key: getPersistentStorageKey(_this4.publicToken, key)
        });
      },
...
var BaseSubscriptionService = /*#__PURE__*/function () {
  function BaseSubscriptionService(_publicToken, _datalayer, _ref10) {
    ...
    this._listen = function (e) {
      if (e.key !== getPersistentStorageKey(_this6._publicToken)) {
        return;
      }
  ...
  function B2BOneTapProvider(_networkClient, _pkceManager) {
    ...
    this.createOnDiscoverySuccessHandler = function (_ref12) {
      ...
      return function (response) {
        return __awaiter(_this0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee1() {
    ...
    this.createOnSuccessHandler = function (_ref13) {
      ...
      return function (response) {
        return __awaiter(_this0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
          var credential, submitPromise;
        ...
        return _regeneratorRuntime().wrap(function _callee14$(_context14) {
          while (1) switch (_context14.prev = _context14.next) {
            ...
            case 6:
              ...
              err = StytchAPIError.from(_context14.t0);
...
var StytchB2BHeadlessClient = /*#__PURE__*/_createClass(function StytchB2BHeadlessClient(rawPublicToken, options) {
  ...
  var usingCustomApiEndpoint = isTestPublicToken(_PUBLIC_TOKEN) ? !!((_a = options === null || options === void 0 ? void 0 : options.endpointOptions) === null || _a === void 0 ? void 0 : _a.testApiDomain) : !!((_b = options === null || options === void 0 ? void 0 : options.endpointOptions) === null || _b === void 0 ? void 0 : _b.apiDomain);
  ...
  this.magicLinks = new HeadlessB2BMagicLinksClient(networkClient, this._subscriptionService, new PKCEManager(this._dataLayer, 'magic_links'), passwordsPKCEManager, bootstrap.getAsync(), dfpProtectedAuth);
  ...
  this.sso = new HeadlessB2BSSOClient(networkClient, this._subscriptionService, new PKCEManager(this._dataLayer, 'sso'), bootstrap.getAsync(), {
    publicToken: _PUBLIC_TOKEN,
    testAPIURL: config.endpoints.testAPIURL,
    liveAPIURL: config.endpoints.liveAPIURL
  }, dfpProtectedAuth);
  this.discovery = new HeadlessB2BDiscoveryClient(networkClient, this._subscriptionService);
  this.passwords = new HeadlessB2BPasswordsClient(networkClient, this._subscriptionService, passwordsPKCEManager, bootstrap.getAsync(), dfpProtectedAuth);
  ...
  this.impersonation = new HeadlessB2BImpersonationClient(this._networkClient, this._subscriptionService, dfpProtectedAuth);
  ...
  var searchManager = new SearchDataManager(networkClient, dfpProtectedAuth);
  var idp = new HeadlessB2BIDPClient(networkClient);
  ...
  bootstrap.getAsync().then(function (bootstrapData) {
    if (bootstrapData.vertical === VERTICAL_CONSUMER) {
      logger.error('This application is using a Stytch client for B2B projects, but the public token is for a Stytch Consumer project. Use a Consumer Stytch client instead, or verify that the public token is correct.');
    }
  });
  var internals = {
    idp: idp,
...
export { OneTapPositions, StytchAPIError, StytchB2BHeadlessClient, StytchSDKUsageError };
